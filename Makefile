#############################################################################
# Makefile for building: workouttracker.app/Contents/MacOS/workouttracker
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  workouttracker.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile workouttracker.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = workouttracker1.0.0
DISTDIR = /Users/waleedalfar/Desktop/workouttracker/.tmp/workouttracker1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		workouttracker.pro  main.cpp
QMAKE_TARGET  = workouttracker
DESTDIR       = 
TARGET        = workouttracker.app/Contents/MacOS/workouttracker

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.4
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/waleedalfar/Desktop/workouttracker/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/waleedalfar/Desktop/workouttracker/workouttracker.pro
...
workouttracker.app/Contents/MacOS/workouttracker:  $(OBJECTS)  
	@test -d workouttracker.app/Contents/MacOS/ || mkdir -p workouttracker.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: workouttracker.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.8.2_1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.8.2_1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.8.2_1/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile workouttracker.pro
...
workouttracker.app/Contents/PkgInfo: 
	@test -d workouttracker.app/Contents || mkdir -p workouttracker.app/Contents
	@$(DEL_FILE) workouttracker.app/Contents/PkgInfo
	@echo "APPL????" > workouttracker.app/Contents/PkgInfo
workouttracker.app/Contents/Info.plist: 
	@test -d workouttracker.app/Contents || mkdir -p workouttracker.app/Contents
	@$(DEL_FILE) workouttracker.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.workouttracker,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.workouttracker,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,workouttracker,g" -e "s,@LIBRARY@,workouttracker,g" -e "s,\$${EXECUTABLE_NAME},workouttracker,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >workouttracker.app/Contents/Info.plist

all: Makefile \
		workouttracker.app/Contents/PkgInfo \
		workouttracker.app/Contents/Info.plist workouttracker.app/Contents/MacOS/workouttracker
